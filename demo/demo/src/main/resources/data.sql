insert into USER (id,username,password,name,surname,phone_number,email,date_of_birth,role,active) values (1,'losmi11','test','Milos','Rankovic','123456','ranko@gmail.com','20-01-1999',1,true);
...
insert into USER (id,username,password,name,surname,phone_number,email,date_of_birth,role,active) values (3,'BabaRoga','test1','Baba','Roga','1234567','buba@gmail.com','19-07-1997',3,true);

insert into TRAINING (id, name, description, type, duration, rating, trainer_id) values (1,'trening1','running 30km','CARDIO','130','3',2);
insert into TRAINING (id, name, description, type, duration, rating, trainer_id) values (2,'trening2','WEIGHTs','STRENGHT','100','4.3',2);
insert into TRAINING (id, name, description, type, duration, rating, trainer_id) values (3,'trening3','Fat burn and strenght','HIIT','20','4.3',2);
insert into TRAINING (id, name, description, type, duration, rating, trainer_id) values (4,'trening4','Bicyle','SPINNING','100','4.3',2);
